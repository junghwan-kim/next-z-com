    ...
    return (
        <PostArticle post={target}>
            ...
            <div className={style.postWrapper}>
                ...
                <Link href={`/${target.User.id}`} className={style.postUserImage} onClick={stopPropagetion}>
                ...
                <div className={style.postBody}>
                    ...
                    {target.Parent && <div>
                        <Link href={`/${target.Parent.User.id}`} style={{ color: 'rgb(29, 155, 240)' }} onClick={stopPropagetion}>@{target.Parent.User.id}</Link> 님에게 보내는 답글
                    </div>}
